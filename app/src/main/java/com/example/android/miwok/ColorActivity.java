...
public class ColorActivity extends AppCompatActivity {
    ...
    public void getWeather(View view) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ColorActivity.this);
    ...
    public void increment(View view) {
        if (n < 96) {
            ...
            Toast.makeText(ColorActivity.this, "Maximum Moisture", Toast.LENGTH_LONG).show();
        }
    }

    public void sethumidity (View view){
        Toast.makeText(ColorActivity.this, "Moisture Set", Toast.LENGTH_SHORT).show();
    }
    ...
    public void decrement(View view) {
        if (n > 20) {
            ...
            Toast.makeText(ColorActivity.this, "Minimum Moisture", Toast.LENGTH_LONG).show();
        }
    }
