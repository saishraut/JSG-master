...
public class FamActivity extends AppCompatActivity {
    ...
    public void getWeather(View view) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FamActivity.this);
    ...
    public void increment(View view) {
        if (n < 96) {
            ...
            Toast.makeText(FamActivity.this, "Maximum Moisture", Toast.LENGTH_LONG).show();
        }
    }

    public void sethumidity (View view){
        Toast.makeText(FamActivity.this, "Moisture Set", Toast.LENGTH_SHORT).show();
    }
    ...
    public void decrement(View view) {
        if (n > 20) {
            ...
            Toast.makeText(FamActivity.this, "Minimum Moisture", Toast.LENGTH_LONG).show();
        }
    }
