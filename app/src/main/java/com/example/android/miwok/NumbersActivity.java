...
public class NumbersActivity extends AppCompatActivity {
    ...
    public void getWeather(View view) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(NumbersActivity.this);
    ...
    public void increment(View view) {
        if (n < 96) {
            ...
            Toast.makeText(NumbersActivity.this, "Maximum Moisture", Toast.LENGTH_SHORT).show();

        }
    }

    public void sethumidity (View view){
        Toast.makeText(NumbersActivity.this, "Moisture Set", Toast.LENGTH_SHORT).show();
    }
    ...
    public void decrement(View view) {
        if (n > 20) {
            ...
            Toast.makeText(NumbersActivity.this, "Minimum Moisture", Toast.LENGTH_SHORT).show();
        }
    }
